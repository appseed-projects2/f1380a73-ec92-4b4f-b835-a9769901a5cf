...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-03 17:00`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f1380a73-ec92-4b4f-b835-a9769901a5cf.git
$ cd f1380a73-ec92-4b4f-b835-a9769901a5cf
```
